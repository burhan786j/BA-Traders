                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($res)) { ?>
                                        <tr>
                                            ...
                                            <td><img src="../uploaded products/<?php echo $row['image'] ?>"/></td>
                                    ...
                                    ?>
                                            ...
                                            <td> 
                                                ...
                                                <a href='manage_product.php?id=".$row['id']."'>Edit</a> </span>&nbsp;";
                                                echo "
                                                <span class='badge btn btn-danger delete'>
